...
namespace Ecommerce.Migrations
{
    ...
    [Migration("20220820042106_CreatingDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Models.Product", b =>
                {
                    ...
                    b.HasIndex("Guid")
                        .IsUnique()
                        .HasDatabaseName("ix_product_guid");
            ...
            modelBuilder.Entity("Ecommerce.Models.ProductCategory", b =>
                {
                    ...
                    b.HasIndex("Guid")
                        .IsUnique()
                        .HasDatabaseName("ix_product_category_guid");
            ...
            modelBuilder.Entity("Ecommerce.Models.ProductInventory", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ecommerce.Models.ProductInventory", b =>
                {
                    b.HasOne("Ecommerce.Models.Product", "Product")
                        ...
                        .HasForeignKey("Ecommerce.Models.ProductInventory", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
