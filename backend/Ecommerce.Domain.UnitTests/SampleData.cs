    ...
    public static class SampleData
    {
        public static List<ProductCategory> GetProductCategories()
        {
            return new List<ProductCategory>
            {
                ...
                new ProductCategory("Clothing", "Fashionable clothing items"),
                new ProductCategory("Home and Kitchen", "Household items and kitchenware")
            };
        }

        public static List<Product> GetProducts()
        {
            var product1 = Product.Create("Smartphone XYZ", "High-end smartphone with advanced features", true, true, 1).Value;
            ...
            var product2 = Product.Create("Laptop ABC", "Powerful laptop for professional use", true, true, 1).Value;
            ...
            var product3 = Product.Create("Men\'s Jeans", "Classic blue jeans for men", true, true, 1).Value;
            ...
            var product4 = Product.Create("Cookware Set", "Complete set of non-stick cookware", true, true, 1).Value;
